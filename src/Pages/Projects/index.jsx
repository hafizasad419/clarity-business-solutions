      ...
      <section className="bg-gradient-to-r from-gray-900 to-gray-800 text-white py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Projects We've Worked On: Review Our Case Studies</h1>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white p-8 rounded-xl shadow-lg mb-12">
              <h2 className="text-3xl font-bold text-gray-800 mb-4">
                Business Thriving Through Our Clarity Business Services
              </h2>
              <p className="text-gray-600 mb-6">
                Learn how an innovative solution, met this client's needs of a biometric solution at a significant cost
                savings compared to what was anticipated.
              </p>
